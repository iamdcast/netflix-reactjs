...
const Login = () => {
  ...
  return (
    <div className='w-full h-screen'>
        <img className='absolute hidden object-cover w-full h-full sm:block' src="https://assets.nflxext.com/ffe/siteui/vlv3/d54727b4-2ad9-4e71-bb48-0899f55f103a/231fe309-d117-409a-afc9-c2249d51a97a/US-en-20230220-popsignuptwoweeks-perspective_alpha_website_medium.jpg" alt="" />
        ...
        <div className='fixed z-50 w-full px-4 py-24'>
            <div className='max-w-[450px] h-[600px] mx-auto bg-black/75 text-white'>
                <div className='max-w-[320px] mx-auto py-16'>
                    ...
                    {error && <p className='p-3 text-white bg-red-400'>{error}</p>}
